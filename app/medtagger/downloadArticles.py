...
import xmltodict
from medtagger.articleMapper import ArticleInfo
from medtagger.models import Journal, Author, Article, Keyword
# from background_task import background


# @background(schedule=60)
def getArticles(term, max_article):

    Entrez.api_key = '8be6f0f087e21da646dfe25fdaaa0f98e909'
    Entrez.email = "uci235@gmail.com"
        ...
        for item in articles_list:
            ...
            if article_info.getPMID():
                ...
                try:
                    ...
                    print('Article cant be saved internal')
                    pass
            else:
